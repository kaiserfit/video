...
QUnit.test('the environment is sane', function (assert) {
  ...
  assert.strictEqual(typeof eventTracking === 'undefined' ? 'undefined' : _typeof(eventTracking), 'function', 'plugin is a function');
});
...
QUnit.test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(_typeof(Player.prototype.eventTracking), 'function', 'videojs-event-tracking plugin was registered');
